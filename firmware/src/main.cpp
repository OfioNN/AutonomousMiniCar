...
void handleRoot() {
    server.send(200, "text/html",
        ...
        "</style></head><body>"
        "<h1>OfioN ~ F1 Car</h1>"
        "<button onclick=\"sendCommand('/forward')\"><svg xmlns='http://www.w3.org/2000/svg' height='72px' viewBox='0 -960 960 960' width='72px' fill='#2854C5'><path d='M440-160v-487L216-423l-56-57 320-320 320 320-56 57-224-224v487h-80Z'/></svg></button><br>"
        "<button onclick=\"sendCommand('/left')\"><svg xmlns='http://www.w3.org/2000/svg' height='72px' viewBox='0 -960 960 960' width='72px' fill='##DA0049'><path d='M400-240 160-480l240-240 56 58-142 142h486v80H314l142 142-56 58Z'/></svg></button>"
        ...
        "<button onclick=\"sendCommand('/right')\"><svg xmlns='http://www.w3.org/2000/svg' height='72px' viewBox='0 -960 960 960' width='72px' fill='#2854C5'><path d='m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z'/></svg></button><br>"
        "<button onclick=\"sendCommand('/back')\"><svg xmlns='http://www.w3.org/2000/svg' height='72px' viewBox='0 -960 960 960' width='72px' fill='#2854C5'><path d='M440-800v487L216-537l-56 57 320 320 320-320-56-57-224 224v-487h-80Z'/></svg></button>"
        "<script>"
...
void forward() {  // Przód: oba silniki do przodu
    ...
    delay(150); // krótki skręt, np. 5–10 stopni
    stop();     // zatrzymanie po krótkim czasie
...
void left() {
    ...
    digitalWrite(IN3, HIGH);
    digitalWrite(IN4, LOW);
    delay(50); // krótki skręt, np. 5–10 stopni
    stop();     // zatrzymanie po krótkim czasie
